...
def DP_PCR(X, Y, epochs=300, faster=True, device='cuda:0'):
    ...
    return register(X, Y, f1, f2, f3, f4, f5, f6, f7, g1, g2, g3, g4, g5, g6, g7, epochs=epochs, batch_size=8_000, faster=faster, device=device)
